...
public class MainApp extends Application {
    ...
    public void loadPersonDataFromFile(File file) {
        try {
        	...
        	alert.setHeaderText("No se ha podido cargar el archivo");     
        	alert.setContentText("Por favor selecciona un archivo correcto");     
        	alert.showAndWait();
        }
    }
    ...
    public void savePersonDataToFile(File file) {
        try {
        	...
        	alert.showAndWait();// catches ANY exception
        }
    }
